...
<html lang="en">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="upcomingrides.html">Lavasa</a></li>
  ...
  <form method="POST" action="includes/lavasa.inc.php">      
    ...
    <button name="lavasa-submit" type="submit">Register</button>
  </form>
